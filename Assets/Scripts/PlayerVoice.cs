...
public class PlayerVoice : MonoBehaviour
{
    ...
    public float lastStrikeTime = -99f;   // for the cooldown, in seconds
    public float lastStrikeBeat = float.MinValue, lastWestBeat = float.MinValue;   // on the song's beat clock: Cross / A, Square / X
    public int lastStrikeMidi, lastWestMidi;
